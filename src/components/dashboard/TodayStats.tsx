    ...
    <Card>
      <div className="px-5 py-4">
        <div className="flex items-start justify-between">
          {/* Health Score */}
          <div>
            <p className="text-[12px] text-white/40 uppercase tracking-wider font-medium">Health Score</p>
